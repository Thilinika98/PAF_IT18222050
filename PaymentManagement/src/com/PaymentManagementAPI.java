...
public class PaymentManagementAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = projectObj.insertProject(request.getParameter("CardType"), 
				request.getParameter("AmountPaid"),
				request.getParameter("ArrearsAmount"),
				request.getParameter("PaidDate"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = projectObj.updateProject(paras.get("hidProjectIDSave").toString(),
				...
				paras.get("AmountPaid").toString(),
				paras.get("ArrearsAmount").toString(),
				paras.get("PaidDate").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		String output = projectObj.deleteProject(paras.get("PaymentId").toString());
